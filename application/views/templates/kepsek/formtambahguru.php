  ...
  <div id="wrapper">
    ...
    <!-- End of Sidebar -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800 text-center">Form Tambah data Guru</h1>
    ...
    <div class="card o-hidden border-0 shadow-lg my-6 col-lg-12 mx-auto">
            ...
            <form class="user" action="<?= base_url('KepalaSekolah/TambahGuru') ?>" method="POST">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="p-5">
                                <label>NIP :</label>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="id_user" placeholder="Masukkan NIP">
                                    <?= form_error('id_user') ?>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="gaji_guru" placeholder="Masukkan Gaji Guru">
                                <?= form_error('gaji_guru') ?>
                            </div>
                            <label>Foto :</label>
                            <div class="form-group">
                                <input type="file" class="form-control" name="foto" placeholder="Masukkan Gaji Guru">
                                <?= form_error('gaji_guru') ?>
                            </div>
                            <br>
                            <br>
