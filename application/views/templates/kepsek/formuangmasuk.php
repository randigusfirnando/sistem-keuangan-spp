            ...
            <div class="row">
              <div class="col-md-9">
                  ...
                  <form action="<?= base_url('KepalaSekolah/TambahDataUangMasuk') ?>" method="post">
                    ...
                    <input type="text" class="form-control" name="nominal" placeholder="Masuk Kan Jumlah Nominal Nya">
                    <?= form_error('nominal') ?>
                  </div>
                  <div class="form-group">
                    <label for="nominal">Tanggal Masuk</label>
                    <input type="date" class="form-control" name="tanggal_masuk" placeholder="Masuk Kan Jumlah Nominal Nya">
                    <?= form_error('tanggal_masuk') ?>
                  </div>
