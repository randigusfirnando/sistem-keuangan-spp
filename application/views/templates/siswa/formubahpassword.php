          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <div class="form-group">
                            ...
                            <?php form_error('password_lama'); ?>
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Password Baru :</label>
                            <input type="text" class="form-control" name="password_baru1">
                            <?php form_error('password_baru1'); ?>
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Ulangi Password :</label>
                            <input type="text" class="form-control" name="password_baru2">
                            <?php form_error('password_baru2'); ?>
                        </div>
